                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <ul class="ms-todo-options">
                                <li><a href="#" class="ms-text-primary"> All Tasks </a></li>
                                <li><a href="#" class="text-disabled"> Completed </a></li>
                                <li><a href="#" class="text-disabled"> Archived </a></li>
                            </ul>
                        </div>
                        <div class="col-xl-5 col-md-6">
                            <ul class="ms-todo-options ms-todo-nav">
                                <li><a href="#" class="ms-text-warning"> <i
                                            class="material-icons">playlist_add_check</i> Remove Completed </a></li>
                                <li><a href="#" class="ms-text-danger"> <i class="material-icons">delete</i> Clear All
                                    </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="ms-card-body">
                    <ul class="ms-list ms-task-block">
                        <li class="ms-list-item ms-to-do-task ms-deletable">
                            ...
                            <button type="submit" class="close"><i class="flaticon-trash ms-delete-trigger">
                                </i></button>
                        </li>
                        <li class="ms-list-item ms-to-do-task ms-deletable">
                            <label class="ms-checkbox-wrap ms-todo-complete">
