                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active show fade in" id="chats-2">
                                    <ul class="ms-scrollable">
                                        ...
                                        <li
                                            class="ms-chat-user-container ms-open-chat selected ms-deletable p-3 media clearfix">
                                            <div
                                    ...
                                    <ul class="ms-scrollable">
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(2).jpg'); }}"
                                                            alt="member"> </li>
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(3).jpg'); }}"
                                                            alt="member"> </li>
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(4).jpg'); }}"
                                                            alt="member"> </li>
                                        ...
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(6).jpg'); }}"
                                                            alt="member"> </li>
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(7).jpg'); }}"
                                                            alt="member"> </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                            ...
                                            <div class="media-body ms-chat-user-info mt-1">
                                                ...
                                                <ul class="ms-group-members clearfix mt-3 mb-0">
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(1).jpg'); }}"
                                                            alt="member"> </li>
                                                    <li> <img
                                                            src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(2).jpg'); }}"
                                                            alt="member"> </li>
                ...
                <div class="ms-panel-body ms-scrollable">
                    <div class="ms-chat-bubble ms-chat-message ms-chat-outgoing media clearfix">
                        <div class="ms-chat-status ms-status-online ms-chat-img">
                            <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(2).jpg'); }}" class="ms-img-round"
                                alt="people">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="ms-chat-bubble ms-chat-message media ms-chat-incoming clearfix">
                        <div class="ms-chat-status ms-status-online ms-chat-img">
                            <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(5).jpg'); }}" class="ms-img-round"
                                alt="people">
                        </div>
                        <div class="media-body">
                            <div class="ms-chat-text">
