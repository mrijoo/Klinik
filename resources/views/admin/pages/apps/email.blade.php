        ...
        <div class="ms-panel-body p-0">
            <div class="ms-email-aside">
                ...
                <ul class="ms-list ms-email-list">
                    ...
                    <li class="ms-list-item ms-active-email"> <a href="#"> <i
                                class="material-icons ms-has-notification">mail</i> Inbox <span>32</span> </a> </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">flag</i> Flagged <span>12</span>
                        </a> </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">chat</i> Spam <span>17</span> </a>
                    </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">drafts</i> Drafts <span>22</span>
                        </a> </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">send</i> Sent <span>51</span> </a>
                    </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">delete</i> Trash <span>33</span>
                        </a> </li>
                </ul>
                <ul class="ms-list ms-email-list">
                ...
                <ul class="ms-list ms-email-list bb-0">
                    ...
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">local_phone</i> Phone Calls
                            <span>2</span> </a> </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">contacts</i> Contacts
                            <span>233</span> </a> </li>
                    <li class="ms-list-item"> <a href="#"> <i class="material-icons">group</i> Groups <span>8</span>
                        </a> </li>
                </ul>
            ...
            <div class="ms-email-main">
                <div class="ms-panel-header">
                    ...
                    <ul class="ms-email-pagination">
                        <li>50-100 of 985</li>
                        <li class="ms-email-pagination-item"> <a href="#" class="ms-email-pagination-link"> <i
                    ...
                    <ul class="ms-scrollable">
                        <li class="media ms-email clearfix">
                            <div class="ms-email-controls">
                                ...
                                <i class="material-icons ms-pin-email">flag</i>
                            </div>
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(2).jpg'); }}"
                            ...
                            <div class="media-body ms-email-details">
                                ...
                                <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in
                                    arcu turpis. Nunc</p>
                            </div>
                            <div class="dropdown">
                                <a href="#" class="ms-hoverable-dropdown" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                        ...
                        <li class="media ms-email pinned clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(4).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                                <h6 class="ms-email-subject">[WordPress] New Comment</h6>
                                <span class="ms-email-time"> <a href="#"><i class="material-icons">attachment</i></a> 2
                                    Hours ago</span>
                                <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in
                                    arcu turpis. Nunc</p>
                            </div>
                        ...
                        <li class="media ms-email clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(6).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                        ...
                        <li class="media ms-email clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(8).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                        ...
                        <li class="media ms-email clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(1).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                        ...
                        <li class="media ms-email clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(3).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                        ...
                        <li class="media ms-email pinned clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(5).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
                        ...
                        <li class="media ms-email clearfix">
                            ...
                            <div class="ms-email-img mr-3 ">
                                <img src="{{ URL::asset('admin/assets/img/dashboard/employee-list/employee-(7).jpg'); }}"
                                    class="ms-img-round" alt="people">
                            </div>
                            <div class="media-body ms-email-details">
                                <span class="ms-email-sender">John Doe</span>
