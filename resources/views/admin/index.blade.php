    ...
    <div class="col-xl-4 col-md-12">
      ...
      <div class="ms-card ms-widget ms-profile-widget ms-card-fh br-0">
        <div class="ms-card-img">
          <img src="{{ URL::asset('admin/assets/img/portfolio/gallery-4-760x260.jpg'); }}" alt="card_img">
        </div>
        <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-1.jpg'); }}" class="ms-img-large ms-img-round ms-user-img" alt="people">
        ...
        <div class="ms-panel-body p-0 ms-medical-overview-slider">
          <div class="ms-crypto-overview">
            <a href="#" class="ms-profile">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-1.jpg'); }}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
              <div class="ms-card-body">
                <h5>Anny</h5>
                <span>Doctor</span>
              </div>
          ...
          <div class="ms-crypto-overview">
            <a href="#" class="ms-profile">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-2.jpg'); }}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
              <div class="ms-card-body">
                <h5>Jude</h5>
                <span>Surgeon</span>
              </div>
          ...
          <div class="ms-crypto-overview">
            <a href="#" class="ms-profile">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-3.jpg'); }}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
              <div class="ms-card-body">
                <h5>Jordan</h5>
                <span>Doctor</span>
              </div>
          ...
          <div class="ms-crypto-overview">
            <a href="#" class="ms-profile">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-4.jpg'); }}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
              <div class="ms-card-body">
                <h5>Micheal</h5>
                <span>Nurse</span>
              </div>
        ...
        <div class="ms-panel-body">
          <div class="table-responsive">
            <table class="table table-hover thead-primary">
              ...
              <tbody>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-1.jpg'); }}" alt="people"> Bernardo Galaviz </td>
                ...
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-5.jpg'); }}" alt="people"> Jenni </td>
                ...
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-6.jpg'); }}" alt="people"> John Doe </td>
                  <td>Dr. Andrew </td>
                  <td>01 Dec 2020</td>
                  <td>10:00 AM</td>
                ...
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-8.jpg'); }}" alt="people"> Alesdro Guitto </td>
                  <td>Dr. Robert </td>
                  <td>01 Dec 2020</td>
                  <td>2:00 PM</td>
                ...
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-1.jpg'); }}" alt="people"> Richard </td>
                  <td>Dr. Adwerd</td>
                  <td>07 Dec 2020</td>
                  <td>5:00 PM</td>
        ...
        <div class="ms-panel-body p-0">
          <ul class="ms-followers ms-list ms-scrollable">
            <li class="ms-list-item media">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-1.jpg'); }}" class="ms-img-small ms-img-round" alt="people">
            ...
            <li class="ms-list-item media">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-2.jpg'); }}" class="ms-img-small ms-img-round" alt="people">
              <div class="media-body mt-1">
                <h4>Jennifer</h4>
            ...
            <li class="ms-list-item media">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-3.jpg'); }}" class="ms-img-small ms-img-round" alt="people">
              <div class="media-body mt-1">
                <h4>Adwerd </h4>
            ...
            <li class="ms-list-item media">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-4.jpg'); }}" class="ms-img-small ms-img-round" alt="people">
              <div class="media-body mt-1">
                <h4>John Doe</h4>
            ...
            <li class="ms-list-item media">
              <img src="{{ URL::asset('admin/assets/img/dashboard/doctor-5.jpg'); }}" class="ms-img-small ms-img-round" alt="people">
              <div class="media-body mt-1">
                <h4>Jordan</h4>
        ...
        <div class="ms-panel-body">
          <div class="table-responsive">
            <table class="table table-hover  thead-primary">
              ...
              <tbody>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-3.jpg'); }}" alt="people"> Richard </td>
                  <td>Richard288@gmail.com</td>
                  <td>+1-202-555-0875</td>
                  <td>Fever</td>
                </tr>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-2.jpg'); }}" alt="people"> William </td>
                  <td>William434@gmail.com</td>
                  <td>+1-202-534-0112</td>
                  <td>Eye</td>
                </tr>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-4.jpg'); }}" alt="people"> John Doe </td>
                  <td>johndeo652@gmail.com</td>
                  <td>+1-202-182-0132</td>
                  <td>Typhoid</td>
                </tr>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-5.jpg'); }}" alt="people"> Martin </td>
                  <td>Martin876@gmail.com</td>
                  <td>+1-202-998-2341</td>
                  <td>Cancer</td>
                </tr>
                <tr>
                  <td class="ms-table-f-w"> <img src="{{ URL::asset('admin/assets/img/dashboard/patient-1.jpg'); }}" alt="people"> Robert </td>
